...
We concentrate here on [simple random sampling](https://www.scribbr.com/methodology/simple-random-sampling/): for each sample set, each stream element (since the start of the sampling) has an equal chance of being a member of the sample set. 
